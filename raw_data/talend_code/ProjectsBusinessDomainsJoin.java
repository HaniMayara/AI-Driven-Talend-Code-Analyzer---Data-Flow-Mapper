...
/**
 * Job: ProjectsBusinessDomainsJoin Purpose: <br>
 * Description: <br>
 * 
...
// ###############################
				...
				String url_tDBInput_2 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "postgres";
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(Jointure)
...
/************************************************************************************************
 * 121855 characters generated by Talend Open Studio for Data Integration on the
 * 27 février 2025 à 12:29:41 WAT
 ************************************************************************************************/