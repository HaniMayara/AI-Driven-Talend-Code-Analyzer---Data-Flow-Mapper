...
package formation.excel_to_csv_0_1;
 ...
 * @status
 */
public class excel_to_csv implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "excel_to_csv.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(excel_to_csv.class);
	...
	private final String jobName = "excel_to_csv";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(excel_to_csv.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = excel_to_csv.class.getClassLoader()
					.getResourceAsStream("formation/excel_to_csv_0_1/contexts/" + currentContext + ".properties");
			if (inContext == null) {
				inContext = excel_to_csv.class.getClassLoader()
	...
	public static class outStruct implements routines.system.IPersistableRow<outStruct> {
		final static byte[] commonByteArrayLock_FORMATION_excel_to_csv = new byte[0];
		static byte[] commonByteArray_FORMATION_excel_to_csv = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FORMATION_excel_to_csv.length) {
					if (length < 1024 && commonByteArray_FORMATION_excel_to_csv.length == 0) {
						commonByteArray_FORMATION_excel_to_csv = new byte[1024];
					} else {
						commonByteArray_FORMATION_excel_to_csv = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FORMATION_excel_to_csv, 0, length);
				strReturn = new String(commonByteArray_FORMATION_excel_to_csv, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FORMATION_excel_to_csv, 0, length);
				strReturn = new String(commonByteArray_FORMATION_excel_to_csv, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FORMATION_excel_to_csv) {
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tFileOutputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_1
									.append("FILENAME" + " = " + "\"D:/DFM data integration/excel_to_csv/output.csv\"");
							log4jParamters_tFileOutputDelimited_1.append(" | ");
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File("D:/DFM data integration/excel_to_csv/output.csv"))
...
// ###############################
					...
					class BytesLimit65535_tFileInputExcel_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputExcel_1
									.append("FILENAME" + " = " + "\"D:/DFM data integration/excel_to_csv/input.xls\"");
							log4jParamters_tFileInputExcel_1.append(" | ");
							log4jParamters_tFileInputExcel_1.append("PASSWORD" + " = "
									+ String.valueOf(
											"enc:routine.encryption.key.v1:38P4En6Da/bxEgnurF2z2uXDehVjT0U8POjtDA==")
											.substring(0, 4)
									+ "...");
							log4jParamters_tFileInputExcel_1.append(" | ");
							...
							log4jParamters_tFileInputExcel_1.append("SHEETLIST" + " = " + "[{USE_REGEX=" + ("false")
									+ ", SHEETNAME=" + ("\"Sheet1\"") + "}]");
							log4jParamters_tFileInputExcel_1.append(" | ");
							log4jParamters_tFileInputExcel_1.append("HEADER" + " = " + "0");
							log4jParamters_tFileInputExcel_1.append(" | ");
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Rnn/uDotmAkezL9U+93bwcnfoE62y1AavPIaRw==");
				...
				Object source_tFileInputExcel_1 = "D:/DFM data integration/excel_to_csv/input.xls";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "Id_commande_client";

									row1.Id_commande_client = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Id_commande_client = null;
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Date_expedition";

									row1.Date_expedition = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Date_expedition = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "Numero_transporteur";

									row1.Numero_transporteur = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.Numero_transporteur = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "out"
								if (out != null) {
									...
									if (out.Id_commande_client != null) {
										sb_tFileOutputDelimited_1.append(out.Id_commande_client);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (out.Date_expedition != null) {
										sb_tFileOutputDelimited_1.append(out.Date_expedition);
									}
									sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
									if (out.Numero_transporteur != null) {
										sb_tFileOutputDelimited_1.append(out.Numero_transporteur);
									}
...
// ###############################      
	...
	public static void main(String[] args) {
		final excel_to_csv excel_to_csvClass = new excel_to_csv();

		int exitCode = excel_to_csvClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'excel_to_csv' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'excel_to_csv' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = excel_to_csv.class.getClassLoader()
					.getResourceAsStream("formation/excel_to_csv_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = excel_to_csv.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : excel_to_csv");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 94277 characters generated by Talend Cloud API Services Platform on the
 * February 12, 2025 3:56:02 PM WAT
 ************************************************************************************************/